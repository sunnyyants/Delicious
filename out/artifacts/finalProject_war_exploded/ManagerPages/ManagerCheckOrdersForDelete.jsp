    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            ...
            <ul class="nav nav-sidebar">
                ...
                <li class="active"><a href="managerCheckOrderForDelete.action">Delete orders</a></li>
            </ul>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h1 class="page-header">Delete Orders</h1>
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <tr align="center">
                        ...
                        <form action="managerDeleteOrder.action" method="post">
