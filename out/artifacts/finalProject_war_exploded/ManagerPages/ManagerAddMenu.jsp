    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            ...
            <ul class="nav nav-sidebar">
                ...
                <li class="active"><a href="preLoadAllGenres.action">Create Menu</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="table-responsive">
                <form class="form-horizontal" action="saveMenu.action" method="post" enctype="multipart/form-data" id="saveMenuForm">
                    <fieldset>
