    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            ...
            <ul class="nav nav-sidebar">
                ...
                <li class="active"><a href="showAllReservationForUpdateAndDelete.action">Check Reservations</a></li>
                ...
                <table class="table table-striped">
                    ...
                    <s:iterator value="reservations" status="status">
                        <tr align="center">
                            ...
                            <td align="center"><s:date name="%{reservationDates[#status.index].reservationDate}" format="yyyy-MM-dd" nice="false"/> </td>
                            <td align="center"><s:property value="tableNumber"/></td>
                            <form action="deleteReservation.action" method="post">
