    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            ...
            <ul class="nav nav-sidebar">
                ...
                <li class="active"><a href="findAllMenuForDelete.action">Delete Menu</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h1 class="page-header">Delete Menus</h1>
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <s:iterator value="listOfMenu" status="status">
                        <tr>
                            ...
                            <td align="center"><s:property value="%{genres[#status.index].name}"/> </td>
                            <td align="center"><s:property value="average"/> </td>

                            <form action="deleteMenu.action" method="post">
