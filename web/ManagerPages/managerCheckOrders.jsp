...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            ...
            <ul class="nav nav-sidebar">
                <li class="active"><a href="managerCheckOrders.action">Show All orders</a></li>
            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <tr align="center">
                        ...
                        <td><s:property value="%{users[#status.index].id}"/></td>
                        <td><s:property value="%{users[#status.index].username}"/></td>
                        <td><s:property value="%{users[#status.index].firstname}"/></td>
                        <td><s:property value="%{users[#status.index].lastname}"/></td>
                        <td><s:property value="%{users[#status.index].email}"/></td>
                        <td><s:property value="%{users[#status.index].phone}"/></td>
                        <td><s:property value="dateOfOrder"/></td>
