...
<div class="container">
    ...
    <form class="form-signin" role="form" action="ManagerloginValidated.action" method="post">
        ...
        <button onclick="location='<%=basePath%>ManagerPages/ManagerRegister.jsp'" class="btn btn-lg btn-primary" style="width: 49%; margin-top: 10px" type="button">Sign up</button>
