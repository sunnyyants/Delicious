    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            ...
            <ul class="nav nav-sidebar">
                ...
                <li class="active"><a href="<%=basePath%>ManagerPages/ManagerAddReservationDate.jsp">Add ReservationDate</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="table-responsive">
                <form class="form-horizontal" action="createReservationDate.action" method="post" enctype="multipart/form-data" id="saveMenuForm">
                    <fieldset>
                        <legend>New Reservation</legend>
                        <div class="form-group">
                            <label for="inputDate" class="col-lg-2 control-label">Date</label>
                            <div class="col-lg-10">
                                <input type="number" class="form-control" id="inputDate" placeholder="days" name="setDays" min="1">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputNum" class="col-lg-2 control-label">Max-Number</label>
                            <div class="col-lg-10">
                                <input type="number" class="form-control" id="inputNum" placeholder="Max-Number" name="maximumReservations" min="1">
                            </div>
                        </div>
                        <div class="form-group">
