    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            ...
            <ul class="nav nav-sidebar">
                ...
                <li class="active"><a href="showAllReservationDate.action">Check ReservationDate</a></li>
                <li><a href="showAllReservationForUpdateAndDelete.action">Check Reservations</a></li>

            </ul>
        </div>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h1 class="page-header">All ReservationDate</h1>
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <tr align="center">
                        ...
                        <td align="center">newmax</td>
                        <td align="center">update</td>
                        <td align="center">delete</td>

                    </tr>
                    <s:iterator value="reservationDates">
                        <tr align="center">
                            <td align="center"><s:property value="id"/> </td>
                            <td align="center"><s:date name="reservationDate" format="yyyy-MM-dd" nice="false"/> </td>
                            <td align="center"><s:property value="maximumReservations"/></td>
                            <td align="center"><s:property value="seatsReserved"/> </td>
                        <form action="updateReservationDate.action" METHOD="post">
                            <td><input type="number" name="maximumReservations" min="1"></td>
                            <input type="hidden" name="id" value="<s:property value="id"/>"/>
                            <td><input type="submit" value="update"/></td>
                        </form>
                            <form action="deleteReservationDate.action" method="post">
                            <input type="hidden" name="id" value="<s:property value="id"/>"/>
